...
local function SetupDefaultPreset()
	...
	widgetHandler:DisableWidget("Chili Selections & CursorTip")
	...
	widgetHandler:EnableWidget("Cursor tooltip")
	widgetHandler:EnableWidget("Darkening")
	widgetHandler:EnableWidget("Death Counter")
	widgetHandler:EnableWidget("Funks EndGame Graph")
	widgetHandler:EnableWidget("Game Time")
	widgetHandler:EnableWidget("HUD Pressets")
	widgetHandler:EnableWidget("Health Bars")
	widgetHandler:EnableWidget("Inventory")
	...
	widgetHandler:EnableWidget("Remove resource bars")
